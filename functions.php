...
function get_header() {
  ...
  <div class="header">
    ...
    <div class="header_text"><?php echo _('BigBrotherBot v1.10+ Config File Generator'); ?></div>
  </div>
  <?php
}
...
function get_footer() {
  ...
  <div class="footer_text">
    ...
    <a href="http://www.bigbrotherbot.net" target='_blank'>BigBrotherBot</a>&nbsp;|<a href="http://config.bigbrotherbot.net/" target='_blank'>B3 Config Generator</a>
    <span class="copyright"><a href="https://github.com/ozguruysal/b3-config-generator" target='_blank'>B3 Config Generator</a>&nbsp;<?php echo _('Copyright'); ?> &copy; <a href="http://ozguruys.al/" target='_blank'>Freelander (Özgür Uysal)</a> 2012 - 2017 - Version <?php echo get_version(); ?></span>
  </div>
</div>
  <?php
}
