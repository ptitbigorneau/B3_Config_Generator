...
function get_b3config_xml_document() {
  ...
  $Comment = 'BigBrotherBot - http://bigbrotherbot.net - BigBrotherBot Config File Generator - Author: Freelander (Özgür Uysal) - http://ozguruys.al';
  $Comment = $doc->createComment($Comment);
  $doc->appendChild($Comment);
  
  $createdby = 'Created by BigBrotherBot v1.10+ Config File Generator(v PB3.1) (' . date("d M Y - D H:i:s T", time()) .')';
